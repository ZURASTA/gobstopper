defmodule Gobstopper.API do
    @moduledoc """
      The APIs for interfacing with the `Gobstopper.Service`.
    ...
    def defaults(opts) do
        Keyword.merge([
            server: Application.get_env(:gobstopper_api, :server, &(&1)),
            timeout: Application.get_env(:gobstopper_api, :timeout, 5000)
        ], opts)
    end
